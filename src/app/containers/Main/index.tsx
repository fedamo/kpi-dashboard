...
import { Grid, Responsive, Tab, Container, Table, Icon, Menu, Header, Divider, Image, Dropdown, Sidebar, Segment, DropdownItem} from "semantic-ui-react";
...
const TestTabs = () => <Tab renderActiveOnly={true} menu={{  secondary: true, attached: true, tabular:true,pointing: true }} menuPosition='left' panes={panes}  />;
const TestTabs1 = () => <Tab renderActiveOnly={true} menu={{  secondary: true, attached: true, tabular:true,pointing: true }} menuPosition='left' panes={panes1}  />;
const TestTabs2 = () => <Tab renderActiveOnly={true} menu={{  tabular:true,pointing: true }} menuPosition='left' panes={panes1}  />;
    ...
    return (
      <Grid columns='equal'>
        <Grid.Column>
          ...
          <Dropdown  placeholder='Select Metrics'  fluid selection   options = {options}  onClick={()=>this.setState({selectedIndex: options.value })}  >
            {/* <Dropdown.Menu   > */}
